...
class Mnist:
    def __init__(self, path, train=True):
        ...
        magic_number, self.number_of_images, image_rows, image_columns = int(self.f.read(4).hex(), 16), \
        ...
        print("Images magic no: {},  No of images: {}, Image rows: {}, Image cols: {}".\
          format(magic_number, self.number_of_images, image_rows, image_columns))
    ...
    def get_batch(self, batch_size=20, scale=True):
        assert(self.number_of_images%batch_size==0)
        ...
        zero_array = np.zeros(shape=[0, 0, 0])
        ...
        for i in range(batch_size):
            ...
            if len(im)>0:
                ...
                im_lst, lbl_lst, lbl_one_hot_lst = zero_array, zero_array, zero_array
                break;
